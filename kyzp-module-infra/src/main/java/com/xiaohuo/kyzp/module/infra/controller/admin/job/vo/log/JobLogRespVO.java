package com.xiaohuo.kyzp.module.infra.controller.admin.job.vo.log;
...
import com.xiaohuo.kyzp.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "kyzp")
