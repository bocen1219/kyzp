package com.xiaohuo.kyzp.module.system.service.social;
...
import com.xiaohuo.kyzp.framework.common.util.cache.CacheUtils;
import com.xiaohuo.kyzp.framework.common.util.http.HttpUtils;
import com.xiaohuo.kyzp.framework.common.util.object.BeanUtils;
import com.xiaohuo.kyzp.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.xiaohuo.kyzp.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.xiaohuo.kyzp.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.xiaohuo.kyzp.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.xiaohuo.kyzp.module.system.controller.admin.social.vo.client.SocialClientPageReqVO;
import com.xiaohuo.kyzp.module.system.controller.admin.social.vo.client.SocialClientSaveReqVO;
import com.xiaohuo.kyzp.module.system.dal.dataobject.social.SocialClientDO;
import com.xiaohuo.kyzp.module.system.dal.mysql.social.SocialClientMapper;
import com.xiaohuo.kyzp.module.system.dal.redis.RedisKeyConstants;
import com.xiaohuo.kyzp.module.system.enums.social.SocialTypeEnum;
import com.xiaohuo.kyzp.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.xiaohuo.kyzp.framework.common.util.collection.MapUtils.findAndThen;
import static com.xiaohuo.kyzp.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.xiaohuo.kyzp.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.xiaohuo.kyzp.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${kyzp.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${kyzp.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/kyzp-cloud/pulls/230
