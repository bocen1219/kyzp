package com.xiaohuo.kyzp.module.system.controller.admin.social.vo.client;
...
import com.xiaohuo.kyzp.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "kyzp商城")
