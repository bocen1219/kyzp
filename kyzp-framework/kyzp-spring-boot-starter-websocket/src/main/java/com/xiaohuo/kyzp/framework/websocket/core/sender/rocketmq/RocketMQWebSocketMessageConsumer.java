package com.xiaohuo.kyzp.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${kyzp.websocket.sender-rocketmq.topic}",
        consumerGroup = "${kyzp.websocket.sender-rocketmq.consumer-group}",
