package com.xiaohuo.kyzp.framework.jackson.config;

import com.xiaohuo.kyzp.framework.common.util.json.JsonUtils;
import com.xiaohuo.kyzp.framework.common.util.json.databind.NumberSerializer;
import com.xiaohuo.kyzp.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.xiaohuo.kyzp.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class KyzpJacksonAutoConfiguration {
