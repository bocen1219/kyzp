package com.xiaohuo.kyzp.framework.web.config;
...
import com.xiaohuo.kyzp.framework.web.core.filter.CacheRequestBodyFilter;
import com.xiaohuo.kyzp.framework.web.core.filter.DemoFilter;
import com.xiaohuo.kyzp.framework.web.core.handler.GlobalExceptionHandler;
import com.xiaohuo.kyzp.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class KyzpWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "kyzp.demo", havingValue = "true")
